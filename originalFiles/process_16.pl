...
%pointCodes = (  # ABC -> 123
 ...
 "BBA" => "621", # Bridge Deck - AGG - Spots only
 "BBB" => "621", # Bridge Deck - BIT - Spots only
 "BBC" => "621", # Bridge Deck - CONC - Spots only
 "BBG" => "319", # Buffalo Box - Gas
 "BBR" => "621", # Bridge Deck - BRICK - Spots only
 ...
 "BDB" => "621", # Bridge Deck. The line of the bit bridge deck.  A 3d line.
 "BDC" => "621", # Bridge Deck. The line of the concrete bridge deck.  A 3d line.
...
%typePrefix = (
 ...
 "BDB" => "2", # 621 - BRIDGE DECK BIT 
 "BDC" => "3", # 621 - BRIDGE DECK CONC
 "BBA" => "1", # 621 - BRIDGE DECK AGG
 "BBB" => "5", # 621 - BRIDGE dECK BIT
 "BBC" => "6", # 621 - BRIDGE DECK CONC
 "BBR" => "4", # 621 - BRIDGE DECK BRICK
 "BWC" => "7", # 621 - Bridge Deck Sidewalk Conc
...
########################################################################################################
%noLine = (
 # created to tri"k the IDOT.smd file, so that is does not draw lines between these codes 
